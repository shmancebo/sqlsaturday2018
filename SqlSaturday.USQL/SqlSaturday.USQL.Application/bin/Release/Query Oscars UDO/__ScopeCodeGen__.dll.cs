...
public class ___Scope_Generated_Classes___
{
	...
	{
		public static Microsoft.Analytics.Interfaces.IProcessor Create_Process_2()
		{
			return new USQL_UDO.ActorDetails();
		}
		public static string Name_Process_2 = "USQL_UDO.ActorDetails";
	}
}
